 ...
 * using `Spheno`.
 */
int Micromegas::mssm_ewsb() { return sphenoEwsbMSSM(); }
...
int Micromegas::mssm_sugra(double tb, double gMG1, double gMG2, double gMG3,
  ...
  return sphenoSUGRA(tb, gMG1, gMG2, gMG3, gAl, gAt, gAb, sgn, gMHu, gMHd, gMl1,
                     gMl3, gMr1, gMr3, gMq1, gMq3, gMu1, gMu3, gMd1, gMd3);
}
} // namespace micromegas
