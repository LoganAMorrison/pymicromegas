...
PYBIND11_MODULE(suspect, m) { // NOLINT

  py::module_::import("pymicromegas");

  static const char *BASE_DOC_STRING_SUGRA = R"pbdoc(
Run micromegas with the parameters define at the GUT scale and settings using suspect as an RGE backend.
...
Run micromegas with the parameters define at the EW scale and settings using suspect as an RGE backend.
