...
def direct_detection_factor_maxwell(pval: float) -> DirectDetectionResults: ...
def direct_detection_factor_shmpp(pval: float) -> DirectDetectionResults: ...
def direct_detection_pval_maxwell() -> DirectDetectionResults: ...
def direct_detection_pval_shmpp() -> DirectDetectionResults: ...
def xenon1T_90(mass: float) -> float: ...
def xenon1T_sdp_90(mass: float) -> float: ...
def xenon1T_sdn_90(mass: float) -> float: ...
def darkside50_90(mass: float) -> float: ...
def darkside50_90_nob(mass: float) -> float: ...
def cresst3_90(mass: float) -> float: ...
def cresst3_sdn_90(mass: float) -> float: ...
def pico60_90(mass: float) -> float: ...
def pico60_sdp_90(mass: float) -> float: ...
def cdm1() -> str: ...
def cdm2() -> str: ...
def mcdm1() -> float: ...
def mcdm2() -> float: ...
...
def relic_density(fast: bool = ..., beps: float = ...) -> Tuple[float, float]: ...
